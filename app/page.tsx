    ...
    <div className="flex items-center justify-center">
      <main className="max-w-xl mb-20 px-2">
        <div className="flex flex-col items-center justify-center py-3">
          <h1 className="font-semibold text-xl text-center">NSW public school canteen income (2022)</h1>
            ...
            {data &&
              data.map((row, index) => (
                <div className="flex items-center justify-between gap-2 py-1" key={index + 1}>
                  ...
                  <div className="flex flex-wrap flex-shrink w-full text-left ">{row.name}</div>
